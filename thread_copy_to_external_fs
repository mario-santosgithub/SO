...
/*
    this test creates 1 inode, and then threads open the
    system and write SIZE (each one), and the close it
    after joining the threads, verifies if the writen is the sum of
    all the writes, (if SIZE*THREADS == I_SIZE)
*/

...
HEADERS  := $(wildcard */*.h)
OBJECTS  := $(SOURCES:.c=.o)
TARGET_EXECS := tests/thread_test_10_simple tests/thread_copy_to_external tests/thread_test_sum 
...
tests/thread_test_10_simple: tests/thread_test_10_simple.o fs/operations.o fs/state.o
tests/thread_copy_to_external: tests/thread_copy_to_external.o fs/operations.o fs/state.o
tests/thread_test_sum: tests/thread_test_sum.o fs/operations.o fs/state.o
